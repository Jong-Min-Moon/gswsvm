...
replication <- 100
n.method <- 10
use.method <- list("gswsvm3"= 1, "gswsvm" = 0, "svm" = 1, "svmdc" = 0, "clusterSVM" = 1, "smotesvm" = 1, "blsmotesvm"= 0, "dbsmotesvm" = 0, "smotedc" = 1)
...
imbalance.ratio.s <- imbalance.ratio / 15
...
p.sigma <- matrix(c(1.5,0,0,1.5),2,2)
